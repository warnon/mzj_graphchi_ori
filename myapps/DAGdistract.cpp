...
struct CheckStep : public GraphChiProgram<VertexDataType, EdgeDataType> {
...
int middle_bound = 0;
int right_bound = 0;
struct CountingStep : public GraphChiProgram<VertexDataType, EdgeDataType> {
...
int main(int argc, const char ** argv) {
	...
	std::cout<<"==============================check Fw-Bw result"<<std::endl;
	engine.set_save_edgesfiles_after_inmemmode(false);
	CheckStep check;	
	engine.run(check, niters);
